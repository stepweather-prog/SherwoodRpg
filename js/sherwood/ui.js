...
_showDefeatScreen: function(rewards) {
    ...
    h += '<div style="text-align:center;"><img src="' + this._statIcons.attack + '" style="width:40px;height:40px;object-fit:contain;"><div style="color:#fff;font-size:1.2em;font-weight:bold;">' + p.stats.attack + '</div></div>';
    h += '<div style="text-align:center;"><img src="' + this._statIcons.defense + '" style="width:40px;height:40px;object-fit:contain;"><div style="color:#fff;font-size:1.2em;font-weight:bold;">' + p.stats.defense + '</div></div>';
    h += '<div style="text-align:center;"><img src="' + this._statIcons.hp + '" style="width:40px;height:40px;object-fit:contain;"><div style="color:#fff;font-size:1.2em;font-weight:bold;">' + p.stats.hp + '</div></div></div>';
    h += '<div style="text-align:center;margin-bottom:8px;"><div onclick="SherwoodUI._showSkinSelector()" style="cursor:pointer;display:inline-block;position:relative;"><img src="assets/hero_skins/' + activeSkin + '.png" style="width:90px;height:90px;border-radius:10px;border:2px solid #ffd700;object-fit:contain;" onerror="this.src=\'assets/hero_skins/skin1_01.png\'"><div style="position:absolute;bottom:-4px;left:50%;transform:translateX(-50%);background:rgba(0,0,0,0.8);color:#ffd700;font-size:0.5em;font-weight:bold;padding:2px 8px;border-radius:4px;">Сменить</div></div><div style="color:#e0c080;font-weight:bold;margin-top:6px;font-size:0.85em;">' + p.name + '</div><div style="color:#aaa;font-size:0.7em;">Уровень ' + p.level + '</div></div>';
