...
Object.assign(UI, {
    ...
    // ============================================================
        ...
        // Верхняя панель стат
        h += '<div style="position:relative;width:94%;max-width:460px;height:100px;margin:0 auto 30px;">';
        ...
        // Одна иконка по центру, под ней плашка, скролл
        h += '<div style="display:flex;flex-direction:column;align-items:center;overflow-y:auto;max-height:calc(100vh - 220px);scrollbar-width:none;-ms-overflow-style:none;padding:20px 0;">';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI._showAllTrophies()">';
        ...
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">' + (trophies.length > 0 ? trophies.length + ' трофеев' : 'Трофеи') + '</div>';
        h += '</div>';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI._showAllRings()">';
        ...
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">' + (ring ? ring.name : 'Кольца') + '</div>';
        h += '</div>';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI._showAllAmulets()">';
        ...
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">' + (amulet ? amulet.name : 'Амулеты') + '</div>';
        h += '</div>';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI.wallet()">';
        h += '<img src="assets/interface/wallet.png" style="width:100px;height:100px;object-fit:contain;">';
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">Кесет</div>';
        h += '</div>';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI.bag()">';
        h += '<img src="assets/assets2/icons/bag.png" style="width:100px;height:100px;object-fit:contain;" onerror="this.src=\'assets/interface/wallet.png\'">';
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">Сумка</div>';
        h += '</div>';
        
        h += '<div style="display:flex;flex-direction:column;align-items:center;margin-bottom:40px;cursor:pointer;" onclick="UI._showTalentsFromProfile()">';
        h += '<img src="assets/all_buttons/ranger_skills_button.png" style="width:100px;height:100px;object-fit:contain;">';
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:8px 40px;color:#ffa500;font-size:1em;font-weight:bold;text-shadow:0 2px 4px #000;margin-top:10px;">Таланты</div>';
        h += '</div>';
