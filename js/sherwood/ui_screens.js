...
UI.profile = function() {
    ...
    for (var i = 0; i < sections.length; i++) {
        ...
        h += '<div style="background:url(\'assets/assets2/game_details/sections_menu.png\') center/100% 100% no-repeat;padding:10px 45px;color:#ffa500;font-size:1.1em;font-weight:bold;text-shadow:0 2px 4px #000;display:inline-block;line-height:1.2;margin-top:50px;margin-bottom:15px;">' + section.name + '</div>';
