...
UI.profile = function() {
    ...
    // Карусель — один подраздел, всё по центру (ИСПРАВЛЕНИЕ Flexbox)
    ...
    for (var i = 0; i < sections.length; i++) {
        ...
        h += '<div class="profile-slide" data-index="' + i + '" onclick="' + section.action + '" style="display:' + display + ';flex-direction:column;align-items:center;justify-content:center;cursor:pointer;text-align:center;padding-top:20px;height:100%;">';
        
        h += '<img src="' + section.icon + '" style="width:140px;height:140px;object-fit:contain;margin:0 auto 20px;display:block;" onerror="this.src=\'assets/interface/labyrinth_of_icons.png\'">';
...
UI.training = function() {
    ...
    for (var i = 0; i < stats.length; i++) {
        ...
        h += '<img src="' + UI._statIcons[s] + '" style="width:64px;height:64px;object-fit:contain;">';
